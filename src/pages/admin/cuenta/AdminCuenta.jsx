...
function AdminCuenta() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://localhost:5000/api/v1/veterinario/obtenerveterinario/6612a9ceed311e2bc5ee35de`
      )
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`http://localhost:5000/api/v1/horario/6612a9ceed311e2bc5ee35de`)
    ...
    if (fecha !== "" && selectedStartTime !== "" && selectedEndTime !== "") {
      ...
      try {
        const response = await axios.patch(
          `http://localhost:5000/api/v1/horario/6612a9ceed311e2bc5ee35de/${fecha}`,
          data
        );
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await axios.delete(
        `http://localhost:5000/api/v1/horario/deletecita/6612a9ceed311e2bc5ee35de/${fecha}`
      );
      setResponseSuccess(response.data.msj);
    } catch (error) {
      if (error.response) {
    ...
    if (
      ...
      try {
        const response = await axios.post(
          "http://localhost:5000/api/v1/horario/6612a9ceed311e2bc5ee35de",
          data
        );
        setResponseSuccess(response.data.msj);
        console.log(response.data.msj);
    ...
    <AdminLayout>
      ...
      <div className="px-10">
        ...
        <div>
          ...
          <Button
            texto="Agregar un nuevo horario"
          ...
          <Modal open={open2} onClose={() => setOpen2(false)}>
            <div className="mx-auto my-4 w-96 mb-3">
              ...
              <p className="text-sm text-gray-500 text-center mt-3">
                ¿Estas seguro que deseas eliminar tu horario para el dia {fecha}
                ?
              </p>
            </div>
            <div className="flex gap-10 mt-10">
