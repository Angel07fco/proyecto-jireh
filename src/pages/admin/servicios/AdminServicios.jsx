...
function AdminServicios() {
  ...
  useEffect(() => {
    ...
    if (token) {
      axios
        .get(`http://localhost:5000/api/v1/services/adminservices`, {
          headers: {
    ...
    if (
      ...
      try {
        const response = await axios.post(
          "http://localhost:5000/api/v1/services/newservice",
          data,
          {
            headers: {
              "x-access-token": token,
  ...
  const confirmHabilitar = async () => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:5000/api/v1/services/habilitar/${id}`,
        {},
        {
          headers: {
            "x-access-token": token,
  ...
  const confirmDeshabilitar = async () => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:5000/api/v1/services/deshabilitar/${id}`,
        {},
        {
          headers: {
            "x-access-token": token,
  ...
  return (
    <AdminLayout>
      ...
      <div className="px-10">
        ...
        <Button
          texto="Agregar un nuevo servicio"
        ...
        <Modal open={open4} onClose={() => setOpen4(false)}>
          <div className="mx-auto my-4 w-96 mb-3">
            ...
            <p className="text-sm text-gray-500 text-center mt-3">
              ¿Estas seguro que deseas habilitar este servicio?
            </p>
          </div>
          <div className="flex gap-10 mt-10">
            <button
        ...
        <Modal open={open5} onClose={() => setOpen5(false)}>
          <div className="mx-auto my-4 w-96 mb-3">
            ...
            <p className="text-sm text-gray-500 text-center mt-3">
              ¿Estas seguro que deseas deshabilitar este servicio?
            </p>
          </div>
          <div className="flex gap-10 mt-10">
            <button
