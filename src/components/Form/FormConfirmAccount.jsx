...
function FormConfirmAccount() {
    ...
    = useForm({ ...initialForm, email }, validationsForm, 3);

    return (
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <img className="mx-auto h-24 w-auto" src={Logo} alt="Logo JIREH" />
                <h2 className="mt-5 text-2xl font-bold leading-9 tracking-tight text-gray-900">¡Activar mi cuenta JIREH!</h2>
                <h5>Por favor, verifique su correo electrónico e ingrese el código de activación.</h5>
            </div>
                                ...
                                <>
                                    {loading
                                        ?
                                            <Loader />
                                        :
                                            <Button texto="Activar cuenta" bg="secondaryBlue" textoColor="white" />
                                    }
                                </>
                            :
                                <ButtonDisabled texto="Activar cuenta" bg="gray-500" />
                        }
                    </div>
                </form>
            </div>
