...
function AdminBlog() {
    ...
    useEffect(() => {
        setLoading(true);
        axios.get(
            `https://backend-jireh.onrender.com/api/v1/blog`
        )
    ...
    const handleRegisterGaleria = async () => {
        if ( titulo === "" || descripcion === "" || selectedCategoria === "" || selectedImage === "" ) {
    ...
    const confirmDelete = async () => {
        setLoading(true);
        try {
            const response = await axios.delete(`https://backend-jireh.onrender.com/api/v1/blog/${id}`);
            setResponseSuccess(response.data.msj);
        } catch (error) {
            if (error.response) {
            setResponseErrors(error.response.data);
        ...
        if ( titulo === "" || descripcion === "" || selectedCategoria === "" || selectedImage === "" ) {
            ...
            try {
                const response = await axios.put(
                    `https://backend-jireh.onrender.com/api/v1/blog/${id}`,
                    data
                );
                setResponseSuccess(response.data.msj);
                console.log(response.data.msj);
