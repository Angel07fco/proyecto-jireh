...
const initialForm = { email: "", indicator: "2" };
...
function FormQuestion() {
    ...
    = useForm(initialForm, validationsForm, 4);
    ...
    return (
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h5>¿Necesitas restablecer tu contraseña? ¡No hay problema! Ingresa tu dirección de correo electrónico y se activara la pregunta secreta.</h5>
            </div>
