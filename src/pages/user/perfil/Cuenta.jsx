            ...
            <div className="flex">
                ...
                <div className="w-full h-[100vh] overflow-y-scroll">
                    ...
                    <div className="my-10 mx-20">
                        <h1 className="text-2xl">En esta sección podra visualizar la información de su perfil y su mascota(s), historial médico de su mascota(s), historial de citas, productos comprados y tratamientos o medicamentos sugeridos para su mascota(s).</h1>
                ...
                <div className="flex flex-wrap">
                    <div className="max-w-full lg:w-1/2 lg:flex-none">
                        <div className="flex flex-col h-full">
                            ...
                            <Link to={link}>
                                <a className="mt-auto flex items-center mb-0 font-semibold leading-normal text-sm group text-slate-500" href="javascript:;">
                                    Ver mas sobre {title}
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="fill-current w-4 h-4 ease-bounce text-sm group-hover:translate-x-1.25 ml-1 leading-normal transition-all duration-200">
                    ...
                    <div className="max-w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
                        ...
                        <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-tailwind/img/shapes/waves-white.svg" className="absolute top-0 hidden w-1/2 h-full lg:block" alt="waves" />
                        <div className="relative flex items-center justify-center h-full">
                            <img className="relative z-20 w-28 h-40 pt-3" src={img} alt={title} />
                        </div>
                        </div>
                    </div>
                </div>
