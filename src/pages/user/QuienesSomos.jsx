...
function QuienesSomos() {
  return (
    <Layout>
      ...
      <div className="flex md:flex-row flex-col md:mx-40 mx-10 pb-20 mt-10">
        <div className="md:w-1/2 flex justify-end">
          <img
            className="w-96"
            src="https://res.cloudinary.com/dl8odylct/image/upload/v1710516024/jireh/quienesomos1_xz4ogi.png"
          />
        </div>
      ...
      <div className="md:mx-40 pb-20">
        <div className="flex justify-center items-center">
          <h2 className="max-w-lg text-4xl font-bold md:text-5xl mt-20">
            Valores de JIREH
          </h2>
        </div>
        <Carrousel />
