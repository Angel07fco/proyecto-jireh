  ...
  const hanSubmit = async (event) => {
    ...
    try {
      const response = await axios.put(
        `https://backend-jireh.onrender.com/api/v1/pet/actualizar/${id._id}`,
        data,
        {
          headers: {
    ...
    <Layout>
      <div className="flex">
        ...
        <div className="w-full h-[100vh] overflow-y-scroll">
          <div className="mx-10">
            <h1 className="bg-secondaryBlue text-primaryBlue p-3 text-3xl text-center mt-5">
              {id.name}
            </h1>
            <div className="mt-10 w-full md:flex">
              ...
              <div className="md:w-4/6 md:px-10 mt-10 md:mt-0">
                <div className="md:flex justify-between md:space-x-5">
                    ...
                    <div className="flex justify-between mb-1">
                      ...
                      {renderName ? (
                        ...
                        <EditIcon
                          ...
                          className="bg-secondaryBlue text-primaryBlue rounded-full p-1"
                          sx={{ fontSize: 25 }}
                        />
                      )}
                    </div>
                  ...
                  <div className="w-full">
                    ...
                    {renderEdad ? (
                      ...
                      <Input disabled value={`${id.age} años`} />
                    )}
                  </div>
                </div>
                ...
                <div className="mt-8">
                  <div className="flex justify-between bg-secondaryBlue mb-2 p-1">
                    ...
                    {renderDetalles ? (
                      <button
                        onClick={() => setRenderDetalles(false)}
                      ...
                      <EditIcon
                        onClick={() => setRenderDetalles(true)}
                        className="bg-secondaryBlue text-primaryBlue rounded-full p-1"
                        sx={{ fontSize: 25 }}
                      />
                    )}
                      ...
                      {renderDetalles ? (
                        ...
                        <div>
                          <div className="md:flex md:space-x-5">
                            <div className="w-full">
                              <Label>Categoria</Label>
                              <Input disabled value={id.categoria} />
                            </div>
                            <div className="w-full">
                              <Label>Especie</Label>
                              <Input disabled value={id.especie} />
                            </div>
                          </div>
                          <div className="md:flex md:space-x-5 mt-3">
                            <div className="w-full">
                              <Label>Tamaño</Label>
                              <Input disabled value={id.tamano} />
                            </div>
                            <div className="w-full">
                              <Label>Genero</Label>
                              <Input disabled value={id.genero} />
                            </div>
                          </div>
                          <div className="flex space-x-5 mt-3">
                            <div className="w-full">
                              <Label>Raza</Label>
                              <Input disabled value={id.raza} />
                            </div>
                          </div>
                        </div>
                      )}
                ...
                <div className="mt-8 mb-10 md:mb-0">
                  <h1 className="text-primaryBlue bg-secondaryBlue mb-2 p-1">
                    - Salud
                  </h1>
                  <div className="md:flex justify-between md:space-x-5">
                    <div className="w-full">
                      ...
                      {renderPeso ? (
                        ...
                        <Input disabled value={`${id.peso} kg.`} />
                      )}
                    </div>
                    <div className="w-full">
                      <div className="flex justify-between mb-1">
          ...
          <div className="mx-10 my-20 hidden md:block">
            <h1 className="bg-secondaryBlue text-primaryBlue p-3 text-3xl text-center mt-5">
              Seguimiento del alimento de mi mascota
            </h1>
            <div className="md:mx-10">
              <h1 className="mt-5 text-secondaryBlue text-lg">
                <span className="font-medium">Datos actualizados: </span>
                05-04-2024
              </h1>
              <div className="mt-5 flex space-x-10">
                <h1 className="text-secondaryBlue text-lg font-medium">
                  Peso:{" "}
                  <span className="bg-secondaryBlue text-primaryBlue p-1 rounded-md">
                    14 kg
                  </span>
                </h1>
                <h1 className="text-secondaryBlue text-lg font-medium">
                  Altura:{" "}
                  <span className="bg-primaryBlue text-secondaryBlue p-1 rounded-md">
                    0.72 m
                  </span>
                </h1>
                <h1 className="text-secondaryBlue text-lg font-medium">
              ...
              <div className="md:flex w-full">
                <div className="w-2/6">
                  <h1 className="mt-8 text-secondaryBlue text-lg font-medium">
                    Recomendado:
                  </h1>
                  <div className="w-[60%] mt-12 ml-[10%] flex flex-col justify-center items-center bg-secondaryBlue pb-2 rounded-lg">
                    <img
                      ...
                      src="https://res.cloudinary.com/dl8odylct/image/upload/v1712689124/jireh/platocomida_rpgllt.png"
                    />
              ...
              <div className="flex mt-8 items-center">
                <h1 className="text-secondaryBlue text-lg font-medium">
                  Calcular el aumento de alimento de mi mascota:
                </h1>
                <Link
                  to="/calculo-alimento"
                  className="underline text-secondaryBlue ml-3"
                >
                  Ir
                </Link>
              </div>
        ...
        <Modal open={open5} onClose={() => setOpen5(false)}>
          <div className="mx-auto my-4 w-96 mb-3">
            ...
            <p className="text-sm text-gray-500 text-center mt-3">
              ¿Estas seguro que deseas eliminar esta mascota?
            </p>
          </div>
