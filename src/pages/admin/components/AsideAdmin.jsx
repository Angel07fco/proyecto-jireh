...
function AsideAdmin() {
    ...
    const Menus = [
        { title: "Citas", path: "/", icon: TodayIcon },
        { title: "Servicios", path: "/", icon: MiscellaneousServicesIcon },
        { title: "Productos", path: "/", icon: AddShoppingCartIcon },
        { title: "Usuarios", path: "/", icon: SupervisedUserCircleIcon },
        { title: "Mascotas", path: "/", icon: PetsIcon },
        //{ title: "Ofertas" },
        //{ title: "Ventas" }
    ]

    const Menu2 = [
        { title: "Mi Cuenta", path: "/", icon: PersonIcon },
        { title: "Reportes", path: "/", icon: AssessmentIcon },
        { title: "Salir", path: "/", icon: LogoutIcon },
    ]
    return (
        <div className="flex">
