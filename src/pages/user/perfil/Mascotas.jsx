      ...
      <div className="flex">
        ...
        <div className="w-full h-[100vh] overflow-y-scroll">
          ...
          <div className="md:mx-20 mx-5">
            <div>
              <h1 className="bg-secondaryBlue p-5 text-primaryBlue font-bold text-center text-2xl">
                Mis mascotas
              </h1>
              {datos.length === 0 ? (
                <p className="text-center font-bold text-secondaryBlue text-xl my-10">
                  No tienes ninguna mascota registrada.
                </p>
              ) : (
                <div className="bg-gradient-to-b from-blue-100 to-blue-200 my-10">
                  <div className="grid md:grid-cols-3 gap-10 py-10 md:px-10 px-5">
                    {datos.map((pet) => (
                      <CardPet
                        key={pet.id}
                        id={pet}
            ...
            <div className="mb-10">
              <h1 className="bg-secondaryBlue p-5 text-primaryBlue font-bold text-center text-2xl mb-5">
...
function CardPet({
  ...
  return (
    <div
      className="w-full bg-white h-auto flex flex-col p-5 rounded-xl cursor-pointer"
      onClick={handleClick}
    >
      <div className="flex justify-between items-center">
        ...
        <h1 className="bg-secondaryBlue text-primaryBlue py-1 px-2 rounded-lg font-medium">
          {especie}
        </h1>
      </div>
      ...
      <div className="px-5">
        <h1 className="text-secondaryBlue font-medium">
          {name} ({genero})
        </h1>
      </div>
      ...
      <div className="px-5 flex justify-between mt-5">
        <div className="">
          <button className="bg-primaryBlue text-secondaryBlue py-1 px-2 rounded-xl">
            Editar
          </button>
          <button className="bg-secondaryBlue text-primaryBlue py-1 px-2 ml-2 rounded-xl">
            Desactivar
          </button>
        </div>
