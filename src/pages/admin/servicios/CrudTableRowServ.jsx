function CrudTableRowServ({el, editData, deleteData, deshabilitar, habilitar}) {

    let { _id, name, img, icono, description, estado } = el;

    return (
        <tr>
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">{name}</td>
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <img src={img} className="w-12 h-12" />
            </td>
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <img src={icono} className="w-12 h-12" />
            </td>
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-normal w-[60%] h-auto max-w-xs break-words">{description}</td>
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                {
                    estado === "disponible"
                    ?
                    ...
                    :
                        ...
                        >
                            ...
                            <h2 className="text-sm font-normal text-red-500">{estado}</h2>
                        </div>
                }
            </td>
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
...
export default CrudTableRowServ