  ...
  return (
    <Layout>
      ...
      <section className="md:mx-40 mx-10">
        ...
        {loading && <Loader />}
        <div className="md:flex md:my-16 md:mr-10">
          <div className="md:w-[55%] md:px-14">
            <h1 className="font-bold text-4xl text-secondaryBlue">
              Siempre al cuidado de tu amiguit@
            </h1>
            <p className="text-lg text-secondaryBlue mt-5">
              En JIREH, nos enorgullece ofrecer una amplia variedad de servicios
              diseñados para satisfacer las necesidades únicas de nuestros
              clientes. Nuestro equipo capacitado se dedica a brindar soluciones
              personalizadas y de calidad en cada servicio que realizamos.
            </p>
          </div>
        ...
        <div className="flex flex-col justify-center items-center">
          <h1 className="font-bold text-5xl text-secondaryBlue mt-10">
            Nuestros servicios
          </h1>
          <h2 className="font-bold text-xl mt-3">
            Todo lo que tus animalitos necesitan, en un solo lugar.
          </h2>
        </div>
